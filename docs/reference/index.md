...
- [SpecTokenUsage](interfaces/SpecTokenUsage.md)
...
- [TanStackMessageMetadata](interfaces/TanStackMessageMetadata.md)
- [TanStackRunMetadata](interfaces/TanStackRunMetadata.md)
...
- [AdapterYieldChunk](type-aliases/AdapterYieldChunk.md)
...
- [getChunkRunId](functions/getChunkRunId.md)
- [getChunkThreadId](functions/getChunkThreadId.md)
...
- [mergeMetadata](functions/mergeMetadata.md)
...
- [normalizeStreamChunk](functions/normalizeStreamChunk.md)
...
- [toSpecTokenUsage](functions/toSpecTokenUsage.md)
...
- [withTanstackMetadata](functions/withTanstackMetadata.md)
