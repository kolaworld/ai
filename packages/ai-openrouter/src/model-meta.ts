...
const DEEPSEEK_DEEPSEEK_V4_FLASH_0731_FREE = {
...
export type OpenRouterModelOptionsByName = {
  ...
  [DEEPSEEK_DEEPSEEK_V4_FLASH_0731_BATCH.id]: OpenRouterCommonOptions &
    Pick<
      ...
      | 'topP'
    >
  [DEEPSEEK_DEEPSEEK_V4_FLASH_0731_FREE.id]: OpenRouterCommonOptions &
    Pick<
      OpenRouterBaseOptions,
      | 'frequencyPenalty'
      | 'logitBias'
...
export type OpenRouterModelInputModalitiesByName = {
  ...
  [DEEPSEEK_DEEPSEEK_V4_FLASH_0731_FREE.id]: ReadonlyArray<'text'>
...
export const OPENROUTER_CHAT_MODELS = [
  ...
  DEEPSEEK_DEEPSEEK_V4_FLASH_0731_FREE.id,
