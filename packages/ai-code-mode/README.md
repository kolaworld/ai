...
1. `packages/ai-code-mode/models-eval/pull-models.sh` — pull recommended Ollama models
...
Canonical output is written to `packages/ai-code-mode/models-eval/results.json` after each capture or judge run.
